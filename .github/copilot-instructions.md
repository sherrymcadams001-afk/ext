...
Project Context:
[A SOTA web and file I/O Agentic AI powered Chrome extension with nuanced perception, resilence, self-awareness, self-correcting, complex task and goal management long running capability all achieved through simple innovative techniques]
